...
autoHunt = setInterval(function() {
    ...
    if (science.value / science.maxValue > 0.98) {
        ...
        if (gamePage.workshop.getCraft('blueprint').unlocked && gamePage.resPool.get('compedium').value > 550 && gamePage.resPool.get('blueprint').value < 100) { gamePage.craft('blueprint', 1); }
    }
}, 5 * 1000);
